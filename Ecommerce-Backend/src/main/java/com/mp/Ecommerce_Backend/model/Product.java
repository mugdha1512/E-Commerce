...
public class Product {
    ...
    public Product(Long id, String title, String description, int price, int discountedPrice, Integer discountPercent,
                   int quantity, String brand, String color, Set<String> sizes, String imageUrl,
                   List<Rating> ratings, List<Review> reviews, int numRatings,
